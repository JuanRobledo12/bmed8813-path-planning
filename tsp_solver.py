...
def calculate_probability_array():
...
def solve_tsp():
    ...
    location_array = np.array([[5.182, 4.369],
                            [3.887, 5.766],
                            [1.943, 4.369],
                            [2.591, 7.976],
                            [8.421, 1.486],
    ...
    w_l = 0.9
    w_d = 0.1
    p_array = calculate_probability_array()
    cost_graph = cost_matrix_calc(location_array, p_array, w_l, w_d)
    ...
    coor_path = generate_path_coor(location_array, solution[0])
    print(coor_path)
    return coor_path
